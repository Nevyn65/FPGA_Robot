...
HD_PWD='C:/Users/84646/Desktop/Robot2.15h/Robot2.00.runs/UART_DATA_FIFO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_DATA_FIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_DATA_FIFO.tcl
