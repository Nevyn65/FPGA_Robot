...
#
# Generated by export_simulation on Fri Nov 01 11:48:30 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './UART_DATA_FIFO.sh' script.

./UART_DATA_FIFO.sh -reset_run
...
./UART_DATA_FIFO.sh -noclean_files

For more information on the script, please type './UART_DATA_FIFO.sh -help'.
